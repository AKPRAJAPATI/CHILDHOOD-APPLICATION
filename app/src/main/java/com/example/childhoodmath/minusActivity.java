...
public class minusActivity extends AppCompatActivity {
        ...
        res_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(firstNumber.getText().toString())) {
                    ...
                    Toast.makeText(minusActivity.this, "A is empty", Toast.LENGTH_SHORT).show();
                } else if (TextUtils.isEmpty(secondNumber.getText().toString())) {
                    linearLayout.setVisibility(View.GONE);
                    Toast.makeText(minusActivity.this, "B is empty", Toast.LENGTH_SHORT).show();
                } else {
                    linearLayout.setVisibility(View.VISIBLE);
                    minusMyAllTheData(firstNumber.getText().toString(), secondNumber.getText().toString());
                }
            }
        });
    ...
    private void minusMyAllTheData(String firstNum, String secondNum) {
        //first line
        a1.setText(firstNum);
        a2.setText(firstNum);
